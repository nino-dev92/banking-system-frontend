                ...
                {history && (
                  <div className="mt-5 flex-col">
                    <div className="flex justify-center">
                      <button
                        className="border w-40 p-2 rounded bg-blue-900 text-white cursor-pointer hover:bg-blue-800"
                        onClick={() =>
                          text === "Show History"
                            ? setText("Hide History")
                    ...
                    {text === "Hide History" && (
                      <ul className="flex-col gap-3">
                        {history.map((item, index) => (
                          <li
                            key={index}
                            className="bg-white border text-center my-2 p-2"
                          >
                            {item}
                          </li>
                        ))}
